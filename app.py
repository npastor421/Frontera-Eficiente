...
with tabs[2]:
    ...
    metrics_summary_dict = {
        ...
        "VaR 95% Mensual (21 Días)": {
            "Cartera Usuario": f"{getattr(metrics_user, 'var_95_monthly', 0.0):.2%}",
            "Máximo Sharpe": f"{getattr(metrics_ms, 'var_95_monthly', 0.0):.2%}",
            "Mínima Varianza (GMV)": f"{getattr(metrics_gmv, 'var_95_monthly', 0.0):.2%}",
            "Equiponderada (1/N)": f"{getattr(metrics_eq, 'var_95_monthly', 0.0):.2%}",
        },
        "CVaR 95% Mensual (21 Días)": {
            "Cartera Usuario": f"{getattr(metrics_user, 'cvar_95_monthly', 0.0):.2%}",
            "Máximo Sharpe": f"{getattr(metrics_ms, 'cvar_95_monthly', 0.0):.2%}",
            "Mínima Varianza (GMV)": f"{getattr(metrics_gmv, 'cvar_95_monthly', 0.0):.2%}",
            "Equiponderada (1/N)": f"{getattr(metrics_eq, 'cvar_95_monthly', 0.0):.2%}",
        },
        "VaR 95% Anual (252 Días)": {
            "Cartera Usuario": f"{getattr(metrics_user, 'var_95_annual', 0.0):.2%}",
            "Máximo Sharpe": f"{getattr(metrics_ms, 'var_95_annual', 0.0):.2%}",
            "Mínima Varianza (GMV)": f"{getattr(metrics_gmv, 'var_95_annual', 0.0):.2%}",
            "Equiponderada (1/N)": f"{getattr(metrics_eq, 'var_95_annual', 0.0):.2%}",
        },
        "CVaR 95% Anual (252 Días)": {
            "Cartera Usuario": f"{getattr(metrics_user, 'cvar_95_annual', 0.0):.2%}",
            "Máximo Sharpe": f"{getattr(metrics_ms, 'cvar_95_annual', 0.0):.2%}",
            "Mínima Varianza (GMV)": f"{getattr(metrics_gmv, 'cvar_95_annual', 0.0):.2%}",
            "Equiponderada (1/N)": f"{getattr(metrics_eq, 'cvar_95_annual', 0.0):.2%}",
        },
